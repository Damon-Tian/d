...
var comment = {
        ...
        <div>
            ...
            <template v-else>
                    <div  v-for='(item,index) in datas' style='display:flex;padding:10px 0 20px;position:relative'>
                        <img :src='"img/people/"+Math.ceil(Math.random()*16)+".png"'  style='width:40px;height:40px;border-radius:50%;padding:10px'>
    ...
    data() {
        return {
            ...
            userName:'',
            id:'',
            imgs:[require('../../public/img/1.jpg'),require('../../public/img/2.jpg'),require('../../public/img/3.jpg')],
            replyName:'',
        }
    },
    mounted() {
