    ...
    data() {
        return {
            ...
            list:[
                ...
                {name:'未签收',singer:'谢霆锋',src:require('../../static/music/未签收.mp3'),img:require('../../static/img/未签收.jpg')},
                {name:'起风了',singer:'xx',src:require('../../static/music/起风了.mp3'),img:require('../../static/img/起风了.jpg')},
            ]
        }
    },
    mounted() {
